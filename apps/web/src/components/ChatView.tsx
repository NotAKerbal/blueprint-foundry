...
export default function ChatView({ threadId }: ChatViewProps) {
  ...
  const _togglePlanSidebar = useCallback(() => {
  ...
  const _setPromptFromTraits = useCallback(
    (nextPrompt: string) => {
                        ...
                        isComposerApprovalState
                          ...
                          : activePendingProgress
                            ...
                            : showPlanFollowUpPrompt && activeProposedPlan
                              ...
                              : phase === "disconnected"
                                ? "Describe the Factorio build you need"
                                : "Describe the factory, target rate, and constraints"
                      }
