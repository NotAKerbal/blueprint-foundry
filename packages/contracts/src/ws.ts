...
import { FactorioGetBlueprintInput } from "./factorio";
...
export const WS_METHODS = {
  ...
  // Factorio artifact methods
  factorioGetBlueprint: "factorio.getBlueprint",
...
const WebSocketRequestBody = Schema.Union([
  ...
  tagRequestBody(WS_METHODS.factorioGetBlueprint, FactorioGetBlueprintInput),
